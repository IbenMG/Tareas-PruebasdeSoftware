...
| ---------- | -------------| -------------  | --------------| ------------- | -------------- |
| **VER-01** | Comprobar mediante pruebas unitarias que la lógica rechaza préstamos de > 3 equipos o > 7 días.| Iben| [Ver evidencia](main/tests/evidencias-testing1-10/TC-04.png) | ✓  |La lógica de negocio rechazó correctamente solicitudes que exceden los límites establecidos. |               |
