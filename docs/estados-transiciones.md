...
de una solicitud o prestamo:

- **SOLICITADA:** La solicitud fue creada por un solicitante y se encuentra pendiente de revision.
...
- **DEVUELTA:** Todos los equipos asociados al prestamo fueron devueltos.
...
## 3. Transiciones no permitidas

El sistema debera impedir, entre otras, las siguientes transiciones:
...
Si una solicitud fue rechazada o cancelada y el solicitante desea realizar
un nuevo prestamo, debera generar una nueva solicitud.

## 4. Roles

### Solicitante

El solicitante podra:
...
## 5. Condiciones que impiden operaciones
...
Una solicitud que contenga múltiples equipos sera tratada como una unidad
completa. Si alguno de los equipo no cumple las condiciones necesarias,
la solicitud completa no podra ser aprobada.
