...
| **CA-19** | **Dado** que una solicitud se encuentra en estado "SOLICITADA", **Cuando** el encargado decida rechazarla, **Entonces** el sistema deberá cambiar su estado a "RECHAZADA" y conservar el cambio registrado. |
